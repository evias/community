...
| Optimized user experience | The package facilitates the usage of Catapult networks. |
| Tested end-to-end | The package is tested with an integration test suite (i.e.: nem2-e2e-tests). |
...
| Tested end-to-end | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :stop_sign: | :stop_sign: | :stop_sign: | :stop_sign: | :stop_sign: |
| Migration features | :heavy_minus_sign: | :heavy_minus_sign: | :white_check_mark: | :stop_sign: | :stop_sign: | :stop_sign: | :stop_sign: | :stop_sign: | :stop_sign: |
| | | | | | | | | | |
| **Deliverables** | | | | | | | | | |
